  ...
  return (
    <>
      <section className="relative flex h-[70vh] min-h-[480px] items-end overflow-hidden bg-ink-950">
        ...
        <div className="container-app relative pb-16 pt-28 sm:pb-20">
          <h1 className="max-w-3xl font-heading text-4xl font-bold leading-[1.05] text-white sm:text-5xl md:text-6xl">
      ...
      <section className="relative overflow-hidden py-16 sm:py-20">
        ...
        <div className="container-app relative">
          <div className="mx-auto max-w-3xl text-center">
            <p className="font-heading text-3xl font-bold leading-snug text-ink-900 sm:text-4xl">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-xl leading-relaxed text-ink-900">
      ...
      <section className="bg-ink-50/60 py-16 sm:py-20">
        <div className="container-app grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <span className="mt-3 block h-1 w-14 rounded-full bg-gradient-to-r from-brand-600 to-brand-300" />
          ...
          <div className="relative">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-brand ring-4 ring-white">
              <Image
                src="https://images.unsplash.com/photo-1539635278303-d4002c07eae3?auto=format&fit=crop&crop=entropy&w=1600&h=1200&q=90"
      ...
      <section className="py-16 sm:py-20">
        <div className="container-app">
          <div className="mx-auto max-w-xl text-center">
            ...
            <span className="mx-auto mt-3 block h-1 w-14 rounded-full bg-gradient-to-r from-brand-600 to-brand-300" />
          </div>
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {pillars.map((p) => (
              <div
                key={p.title}
                className="group relative overflow-hidden rounded-2xl border border-ink-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-brand"
              >
                ...
                <span className="grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br from-brand-50 to-brand-100 text-brand-600 transition group-hover:from-brand-600 group-hover:to-brand-500 group-hover:text-white">
                  <p.icon className="h-5 w-5" />
                </span>
                <h3 className="mt-4 font-heading text-lg font-bold text-ink-900">
                  {p.title}
                </h3>
                <p className="mt-1.5 text-base leading-relaxed text-ink-900">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-ink-50/60 py-16 sm:py-20">
        <div className="container-app grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="relative lg:order-2">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-brand ring-4 ring-white">
              <Image
                src="https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&crop=entropy&w=1600&h=1200&q=90"
        ...
        <div className="container-app">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 via-brand-500 to-brand-700 px-6 py-14 text-center shadow-brand sm:px-16 sm:py-16">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-3 max-w-md text-base text-white sm:text-lg">
