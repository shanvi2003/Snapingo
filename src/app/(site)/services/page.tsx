    ...
    <section className="bg-ink-50/60 pb-16 pt-28 sm:pb-20 sm:pt-32">
      <div className="container-app">
        <div className="mx-auto max-w-xl text-center 3xl:max-w-2xl">
          <h1 className="font-heading text-3xl font-bold text-ink-900 sm:text-4xl 3xl:text-5xl">
            Our Services
          </h1>
          <p className="mt-3 text-base text-ink-900 sm:text-lg 3xl:text-xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4 3xl:gap-8">
