...
export function InstagramIcon({ className }: IconProps) {
  // Unique per render - this icon renders more than once on the same page
  // (e.g. the footer's mobile/tablet and desktop layout blocks both mount
  // it at once, only one hidden via CSS), and a shared, hardcoded gradient
  // id collides across those instances, breaking the fill on one of them.
