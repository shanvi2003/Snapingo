...
export default function ContactForm({ destinations }: { destinations: Destination[] }) {
  ...
  const destinationOptions = [
    ...
    ...destinations.filter((d) => d.type === tripType).map((d) => ({
      value: d.name,
      label: d.name,
    })),
  ];
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    createLeadAction({
      ...
      dateMode,
      startDate: dateMode === "fixed" ? (form.get("startDate")?.toString() || undefined) : undefined,
      endDate: dateMode === "fixed" ? (form.get("endDate")?.toString() || undefined) : undefined,
      days: dateMode === "flexible" ? (form.get("days")?.toString() || undefined) : undefined,
      message: message || undefined,
      raw: dateMode === "flexible" ? { nights: form.get("nights")?.toString() } : undefined,
