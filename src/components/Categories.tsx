            ...
            return (
              ...
              >
                ...
                <div className="relative flex h-full flex-col justify-between p-4 sm:p-5">
                  <span className="grid h-11 w-11 place-items-center text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.4)] transition-transform duration-500 ease-out group-hover:-rotate-6 group-hover:scale-110 sm:h-12 sm:w-12">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[11px] leading-snug text-white/80 sm:text-xs">
                      {cat.desc}
                    </p>
                  </div>
                </div>
