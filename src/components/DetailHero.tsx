...
export default function DetailHero({
  ...
  return (
    <section className="print-plain-hero relative flex h-[62vh] min-h-[420px] items-end overflow-hidden bg-ink-950 sm:h-[70vh]">
      ...
      <div className="container-app relative pb-10 pt-28 sm:pb-14">
        <motion.div
        ...
        {meta.length > 0 && (
          <motion.div
            ...
            className="print-show-opaque mt-7 flex flex-wrap gap-3"
          >
            {meta.map((m) => (
              <span
                key={m.label}
