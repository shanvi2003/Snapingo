...
export default function TravelGuideModal() {
  const [open, setOpen] = useAutoOpenOnce("snapingo-travelguide-flow-seen");
  ...
  const destinationList = tripType === "domestic" ? domesticDestinations : internationalDestinations;
